...
import ai.vespa.examples.MyClojure;
...
public class ExampleProcessor extends Processor {
    ...
    public Response process(Request request, Execution execution) {
        ...
        MyClojure myClojure = new MyClojure();
        response.data().add(new StringData(request, myClojure.foo()));
        response.data().add(new StringData(request, MyClojure.data()));
